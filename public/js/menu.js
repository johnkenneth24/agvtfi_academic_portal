      ...
      [
        {
          ...
          value: function _bindEvents() {
            ...
            this._evntElClick = function (e) {
              ...
              var toggleLink = e.target.classList.contains("menu-toggle")
                ? e.target
            ...
            this._evntWindowResize = function () {
              ...
              var horizontalMenuTemplate = document.querySelector(
          ...
          value: function open(el) {
            ...
            var closeChildren =
              arguments.length > 1 && arguments[1] !== undefined
                ? arguments[1]
                : this._closeChildren;
            var item = this._findUnopenedParent(
              ...
              .then(function () {
                if (!_this3._horizontal || !Menu._isRoot(item)) {
                  if (_this3._animate && !_this3._horizontal) {
                    window.requestAnimationFrame(function () {
                      return _this3._toggleAnimation(
                        false,
                        item,
                        closeChildren
                      );
        ...
        },
        {
          ...
          value: function _closeOther(item, closeChildren) {
            var opened = Menu._findChild(item.parentNode, [
              "menu-item",
              "open",
            ]);
            for (var i = 0, l = opened.length; i < l; i++) {
        ...
        },
        {
          ...
          value: function _findUnopenedParent(item, closeChildren) {
            ...
            for (var i = 0, l = tree.length; i < l; i++) {
              ...
              if (this._accordion) {
                var openedItems = Menu._findChild(tree[i].parentNode, [
                  "menu-item",
                  "open",
                ]);
          ...
          value: function closeAll() {
            var closeChildren =
              arguments.length > 0 && arguments[0] !== undefined
                ? arguments[0]
                : this._closeChildren;
            var opened = this._el.querySelectorAll(
        ...
        },
        {
          ...
          value: function manageScroll() {
            ...
            if (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT) {
              ...
              if (this._scrollbar === null) {
                var menuScroll = new PerfectScrollbar(
